using IronDB.Core.Server.Platform.Win32;
using System.ComponentModel;
using System.Runtime.InteropServices;

namespace IronDB.Core.Server.Debugging;

internal static unsafe class Win32ElectricFencedMemory
{
    public static byte* Allocate(int size)
    {
        ...
        *(int*)virtualAlloc = allocatedSize;
        ...
        if (!Win32MemoryProtectMethods.VirtualProtect(virtualAlloc, (UIntPtr)4096, Win32MemoryProtectMethods.MemoryProtection.NOACCESS,
                out Win32MemoryProtectMethods.MemoryProtection protect))
        {
    ...
    public static void Free(byte* p)
    {
        ...
        if (!Win32MemoryProtectMethods.VirtualProtect(address, (UIntPtr)4096, Win32MemoryProtectMethods.MemoryProtection.READWRITE, out Win32MemoryProtectMethods.MemoryProtection protect))
        {
        ...
        if (!Win32MemoryProtectMethods.VirtualFree(address, (UIntPtr)dwSize, Win32MemoryProtectMethods.FreeType.MEM_DECOMMIT))
        {
