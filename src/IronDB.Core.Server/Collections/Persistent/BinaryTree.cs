using IronDB.Core.Server.Binary;
using System.Runtime.CompilerServices;
using System.Runtime.InteropServices;

namespace IronDB.Core.Server.Collections.Persistent;

public ref struct BinaryTree<T> 
    where T : struct
{
    ...
    private struct Node
    {
        ...
        public ushort LeftChild
        {
            ...
            readonly get { return (ushort)(_leftChild & ValueMask); }
            set
            {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            readonly get { return (ushort)(_rightChild & ValueMask); }
            set
            {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            readonly get { return (_leftChild & HasValueMask) != 0; }
    ...
    private readonly ushort FreeNodes
    {
        get { return MemoryMarshal.Read<ushort>(_storage); }
        set { MemoryMarshal.Write(_storage, in value); }
    }

    public readonly int MaxNodes => _nodes.Length - 1;
    public readonly int AvailableNodes => _nodes.Length - FreeNodes - 1;
    public readonly int MemoryUsed => (MaxNodes - AvailableNodes) * Unsafe.SizeOf<Node>() + sizeof(ushort);
    ...
    public BinaryTree(Span<byte> storage)
    {
        ...
        if (_nodes.Length > short.MaxValue)
        {
            ...
            _storage = _storage[..(short.MaxValue - 1)];
        }
    }
    ...
    public readonly bool Find(ref BitReader key, out T value)
    {
        Span<Node> nodes = _nodes;
