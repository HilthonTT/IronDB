...
internal unsafe partial struct Avx2VectorizedSort
{
    ...
    internal struct UInt64Config
    {
        ...
        public const int PartitionTempSizeInBytes = PartitionTempSizeInElements * sizeof(ulong);
        public const int ElementAlign = sizeof(ulong) - 1;
    }


    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static ulong* align_left_scalar_uncommon(ulong* read_left, ulong pivot, ref ulong* tmp_left, ref ulong* tmp_right)
    {
        ...
        if (((ulong)read_left & UInt64Config.ALIGN_MASK) == 0)
            return read_left;

        var next_align = (ulong*)(((ulong)read_left + UInt64Config.ALIGN) & ~UInt64Config.ALIGN_MASK);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static ulong* align_right_scalar_uncommon(ulong* readRight, ulong pivot, ref ulong* tmpLeft, ref ulong* tmpRight)
    {
        ...
        if (((ulong)readRight & UInt64Config.ALIGN_MASK) == 0)
            return readRight;

        var nextAlign = (ulong*)((ulong)readRight & ~UInt64Config.ALIGN_MASK);
    ...
    private static void align_vectorized(
        ...
        in V p,
        byte* pBase,
        ref ulong* readLeft, ref ulong* readRight,
        ref ulong* tmpStartLeft, ref ulong* tmpLeft,
        ref ulong* tmpStartRight, ref ulong* tmpRight)
    {
        ...
        var additionConstant = Vector256.Create(unchecked((ulong)-1));
        var signedP = Add(p, additionConstant).AsInt64();
        var rtMask = (uint)MoveMask(CompareGreaterThan(Add(RT0, additionConstant).AsInt64(), signedP).AsDouble()); //default(MT).get_cmpgt_mask(RT0, p);
        var ltMask = (uint)MoveMask(CompareGreaterThan(Add(LT0, additionConstant).AsInt64(), signedP).AsDouble()); //default(MT).get_cmpgt_mask(LT0, p);
        ...
        RT0 = PermuteVar8x32(RT0.AsSingle(), ConvertToVector256Int32(LoadVector128(pBase + rtMask * 8))).AsUInt64();
        Store(tmpRight, RT0);

        LT0 = PermuteVar8x32(LT0.AsSingle(), ConvertToVector256Int32(LoadVector128(pBase + ltMask * 8))).AsUInt64();
        Store(tmpLeft, LT0);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private static void partition_block(V dataVec, V p, byte* pBase, ref ulong* left, ref ulong* right)
    {
        var additionConstant = Vector256.Create(unchecked((ulong)-1));
        var mask = (ulong)(uint)MoveMask(CompareGreaterThan(Add(dataVec, additionConstant).AsInt64(), Add(p, additionConstant).AsInt64()).AsDouble());
        ...
        var maskedDataVec = PermuteVar8x32(dataVec.AsSingle(), ConvertToVector256Int32(LoadVector128(pBase + mask * 8))).AsUInt64();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private static void LoadAndPartition1Vectors(ulong* dataPtr, V P, byte* pBase, ref ulong* writeLeftPtr, ref ulong* writeRightPtr)
    {
        ...
        var d1 = LoadAlignedVector256((ulong*)(dataPtr + N * 0));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private static void LoadAndPartition4Vectors(ulong* dataPtr, V P, byte* pBase, ref ulong* writeLeftPtr, ref ulong* writeRightPtr)
    {
        // PERF: Unroll and CompressWrite support is been treated as a constant because we make sure the caller
        //       treats that parameter already as a constant @ JIT time causing a cascade.
        ...
        var d4 = LoadAlignedVector256((ulong*)(dataPtr + N * 0));
        var d3 = LoadAlignedVector256((ulong*)(dataPtr + N * 1));
        var d2 = LoadAlignedVector256((ulong*)(dataPtr + N * 2));
        var d1 = LoadAlignedVector256((ulong*)(dataPtr + N * 3));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private static void LoadAndPartition8Vectors(ulong* dataPtr, V P, byte* pBase, ref ulong* writeLeftPtr, ref ulong* writeRightPtr)
    {
        // PERF: Unroll and CompressWrite support is been treated as a constant because we make sure the caller
        //       treats that parameter already as a constant @ JIT time causing a cascade.
        ...
        var d8 = LoadAlignedVector256((ulong*)(dataPtr + N * 0));
        var d7 = LoadAlignedVector256((ulong*)(dataPtr + N * 1));
        var d6 = LoadAlignedVector256((ulong*)(dataPtr + N * 2));
        var d5 = LoadAlignedVector256((ulong*)(dataPtr + N * 3));
        var d4 = LoadAlignedVector256((ulong*)(dataPtr + N * 4));
        var d3 = LoadAlignedVector256((ulong*)(dataPtr + N * 5));
        var d2 = LoadAlignedVector256((ulong*)(dataPtr + N * 6));
        var d1 = LoadAlignedVector256((ulong*)(dataPtr + N * 7));
    ...
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private ulong* vectorized_partition_8(ulong* left, ulong* right, long hint)
    {
        Debug.Assert(right - left >= UInt64Config.SmallSortThresholdElements);
        Debug.Assert(((long)left & UInt64Config.ElementAlign) == 0);
        Debug.Assert(((long)right & UInt64Config.ElementAlign) == 0);
        ...
        *right = ulong.MaxValue;
        ...
        var tmpStartLeft = (ulong*)_tempPtr;
        var tmpLeft = tmpStartLeft;
        var tmpStartRight = tmpStartLeft + UInt64Config.PartitionTempSizeInElements;
        var tmpRight = tmpStartRight;

        tmpRight -= UInt64Config.N;
        ...
        Debug.Assert(((ulong)readLeft & UInt64Config.ALIGN_MASK) == 0);
        Debug.Assert(((ulong)readRight & UInt64Config.ALIGN_MASK) == 0);

        Debug.Assert((((ulong)readRight - (ulong)readLeft) % UInt64Config.ALIGN) == 0);
        Debug.Assert((readRight - readLeft) >= UInt64Config.Unroll * 2);
        ...
        var pointers = stackalloc ulong*[2];
        pointers[0] = readLeftV;
        pointers[1] = readRightV - UInt64Config.Unroll * UInt64Config.N;
        ...
        readLeftV += UInt64Config.N * UInt64Config.Unroll;
        readRightV -= UInt64Config.N * UInt64Config.Unroll * 2;

        ulong* nextPtr;

        var writeLeft = left;
        var writeRight = right - UInt64Config.N;

        while (readLeftV < readRightV)
        {
            if ((byte*)writeRight - (byte*)readRightV < (2 * (UInt64Config.Unroll * UInt64Config.N) - UInt64Config.N) * sizeof(ulong))
            {
                ...
                nextPtr = readRightV;
                readRightV -= UInt64Config.N * UInt64Config.Unroll;
            }
            else
            {
        ...
        int unrollHalf = UInt64Config.Unroll / 2;
        readRightV += UInt64Config.N * unrollHalf;
        while (readLeftV < readRightV)
        {
            if ((byte*)writeRight - (byte*)readRightV < (2 * (unrollHalf * UInt64Config.N) - UInt64Config.N) * sizeof(ulong))
            {
            ...
            else
            {
                ...
                // PERF: Ensure that JIT never emits cmov here.
                nextPtr = readLeftV;
                readLeftV += UInt64Config.N * unrollHalf;
            }

            LoadAndPartition4Vectors(nextPtr, P, pBase, ref writeLeft, ref writeRight);
        }

        readRightV += UInt64Config.N * (unrollHalf - 1);
        ...
        while (readLeftV <= readRightV)
        {
            if ((byte*)writeRight - (byte*)readRightV < UInt64Config.N * sizeof(ulong))
            {
                nextPtr = readRightV;
                readRightV -= UInt64Config.N;
            }
            else
            {
                // PERF: Ensure that JIT never emits cmov here.
                nextPtr = readLeftV;
                readLeftV += UInt64Config.N;
            }
        ...
        Unsafe.CopyBlockUnaligned(writeLeft, tmpStartLeft, (uint)(leftTmpSize * sizeof(ulong)));
        writeLeft += leftTmpSize;


        var rightTmpSize = tmpStartRight - tmpRight;
        Unsafe.CopyBlockUnaligned(writeLeft, tmpRight, (uint)(rightTmpSize * sizeof(ulong)));
    ...
    private static void Swap(ulong* left, ulong* right)
    {
        var tmp = *left;
        *left = *right;
        *right = tmp;
    ...
    private static unsafe void SwapIfGreater(ulong* leftPtr, ulong* rightPtr)
    {
        if (*leftPtr <= *rightPtr) return;
        Swap(leftPtr, rightPtr);
    }

    private static unsafe void SwapIfGreater3(in ulong* leftPtr, in ulong* middlePtr, in ulong* rightPtr)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static void down_heap(long i, long n, ulong* lo)
    {
        var d = *(lo + i - 1);
        long child;
        while (i <= n / 2)
    ...
    static void heap_sort(ulong* lo, ulong* hi)
    {
        long n = hi - lo + 1;
    ...
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private static Vector256<uint> pack_vectorized(V baseVec, V d1, V d2)
    {
        byte Shift = 0;
        ...
        return Blend(di1, di2, 0b10101010).AsUInt32();
    ...
    {
        var NFrom = V.Count;
        var NTo = Vector256<uint>.Count;
        var Unroll = 8;

        var offset = @base - uint.MinValue;
        var baseVec = Vector256.Create(offset);

        var pre_aligned_mem = (ulong*)((ulong)mem & ~UInt64Config.ALIGN_MASK);
        var mem_read = (ulong*)mem;
        var mem_write = (uint*)mem;
        ...
        if (len < NFrom)
        {
            while (len > 0)
            {
                ...
                *mem_write = (uint)(*mem_read - offset);
                mem_read++;
                mem_write++;
            }
            return;
        ...
        Debug.Assert(((ulong)(mem_read) & UInt64Config.ALIGN_MASK) == 0);
        ...
        while (lenv >= 2 * Unroll)
        {
            ...
            var d0 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 0));
            var d1 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 1));

            var d2 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 2));
            var d3 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 3));

            var d4 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 4));
            var d5 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 5));

            var d6 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 6));
            var d7 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 7));

            var d8 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 8));
            var d9 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 9));

            var d10 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 10));
            var d11 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 11));

            var d12 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 12));
            var d13 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 13));

            var d14 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 14));
            var d15 = LoadAlignedVector256((ulong*)(memv_read + NFrom * 15));
    ...
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private static void unpack_vectorized(V baseVec, Vector256<uint> d0, out V u0, out V u1)
    {
        byte Shift = 0;


        u0 = ConvertToVector256Int64(ExtractVector128(d0, 0)).AsUInt64();
        u1 = ConvertToVector256Int64(ExtractVector128(d0, 1)).AsUInt64();
    ...
    private static void Unpack(void* mem, int len, ulong @base)
    {
        ...
        var mem_read = ((uint*)mem) + len;
        var mem_write = ((ulong*)mem) + len;
        ...
        var pre_aligned_mem = (uint*)((ulong)mem_read & ~UInt64Config.ALIGN_MASK);
        ...
        while (lenv >= Unroll)
        {
            ...
            var d0 = LoadVector256((uint*)(memv_read - NTo * 0));
            var d1 = LoadVector256((uint*)(memv_read - NTo * 1));
            var d2 = LoadVector256((uint*)(memv_read - NTo * 2));
            var d3 = LoadVector256((uint*)(memv_read - NTo * 3));
            var d4 = LoadVector256((uint*)(memv_read - NTo * 4));
            var d5 = LoadVector256((uint*)(memv_read - NTo * 5));
            var d6 = LoadVector256((uint*)(memv_read - NTo * 6));
            var d7 = LoadVector256((uint*)(memv_read - NTo * 7));
    ...
    internal void sort(ulong* left, ulong* right, ulong left_hint, ulong right_hint, long hint, int depth_limit)
    {
        ...
        if (length <= UInt64Config.SmallSortThresholdElements)
        {
        ...
        if ((ulong)(right_hint - left_hint) < uint.MaxValue << 0)
        {
            ...
            sorter.sort(il, ir, 0, 0, UInt64Config.REALIGN_BOTH, depth_limit);
        ...
        var preAlignedLeft = (ulong*)((ulong)left & ~UInt64Config.ALIGN_MASK);
        var cannotPreAlignLeft = ((long)preAlignedLeft - (long)_startPtr) >> 63;
        var preAlignLeftOffset = (preAlignedLeft - left) + (UInt64Config.N & cannotPreAlignLeft);
        if ((hint & UInt64Config.REALIGN_LEFT) != 0)
        {
            // Alignment flow:
        ...
        var preAlignedRight = (ulong*)(((ulong)right - 1 & ~UInt64Config.ALIGN_MASK) + UInt64Config.ALIGN);
        var cannotPreAlignRight = ((long)_endPtr - (long)preAlignedRight) >> 63;
        var preAlignRightOffset = (preAlignedRight - right - (UInt64Config.N & cannotPreAlignRight));
        if ((hint & UInt64Config.REALIGN_RIGHT) != 0)
        {
        ...
        Debug.Assert(((ulong)(left + (hint & 0xFFFFFFFF)) & UInt64Config.ALIGN_MASK) == 0);
        Debug.Assert(((ulong)(right + (hint >> 32)) & UInt64Config.ALIGN_MASK) == 0);
        ...
        sort(left, sep - 2, left_hint, *sep, hint | UInt64Config.REALIGN_RIGHT, depth_limit);

        sort(sep, right, *(sep - 2), right_hint, hint | UInt64Config.REALIGN_LEFT, depth_limit);
