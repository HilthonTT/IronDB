...
internal unsafe partial struct Avx2VectorizedSort
{
    ...
    private static int* align_left_scalar_uncommon(int* read_left, int pivot, ref int* tmp_left, ref int* tmp_right)
    {
        ...
        if (((ulong)read_left & Int32Config.ALIGN_MASK) == 0)
            return read_left;

        var next_align = (int*)(((ulong)read_left + Int32Config.ALIGN) & ~Int32Config.ALIGN_MASK);
    ...
    private static int* align_right_scalar_uncommon(int* readRight, int pivot, ref int* tmpLeft, ref int* tmpRight)
    {
        ...
        if (((ulong)readRight & Int32Config.ALIGN_MASK) == 0)
            return readRight;

        var nextAlign = (int*)((ulong)readRight & ~Int32Config.ALIGN_MASK);
    ...
    private int* vectorized_partition_8(int* left, int* right, long hint)
    {
        ...
        *right = int.MaxValue;
        ...
        Debug.Assert(((ulong)readLeft & Int32Config.ALIGN_MASK) == 0);
        Debug.Assert(((ulong)readRight & Int32Config.ALIGN_MASK) == 0);

        Debug.Assert((((ulong)readRight - (ulong)readLeft) % Int32Config.ALIGN) == 0);
    ...
    internal void sort(int* left, int* right, int left_hint, int right_hint, long hint, int depth_limit)
    {
        ...
        var preAlignedLeft = (int*)((ulong)left & ~Int32Config.ALIGN_MASK);
        ...
        if ((hint & Int32Config.REALIGN_LEFT) != 0)
        {
            // Alignment flow:
        ...
        var preAlignedRight = (int*)(((ulong)right - 1 & ~Int32Config.ALIGN_MASK) + Int32Config.ALIGN);
        ...
        if ((hint & Int32Config.REALIGN_RIGHT) != 0)
        {
        ...
        Debug.Assert(((ulong)(left + (hint & 0xFFFFFFFF)) & Int32Config.ALIGN_MASK) == 0);
        Debug.Assert(((ulong)(right + (hint >> 32)) & Int32Config.ALIGN_MASK) == 0);
        ...
        sort(left, sep - 2, left_hint, *sep, hint | Int32Config.REALIGN_RIGHT, depth_limit);

        sort(sep, right, *(sep - 2), right_hint, hint | Int32Config.REALIGN_LEFT, depth_limit);
