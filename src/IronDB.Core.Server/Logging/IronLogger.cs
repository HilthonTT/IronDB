...
using NLog;
using LogLevel = IronDB.Core.Logging.LogLevel;

namespace IronDB.Core.Server.Logging;

public sealed class IronLogger : IIronLogger
{
    private readonly Logger _logger;

    public IronLogger(Logger logger)
    {
    ...
    public IIronLogger WithProperty(string propertyKey, object propertyValue)
    {
        return new IronLogger(_logger.WithProperty(propertyKey, propertyValue));
    }
}
