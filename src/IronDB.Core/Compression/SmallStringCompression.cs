...
/// </summary>
internal sealed unsafe class SmallStringCompression
{
    ...
    public static SmallStringCompression Instance = new(DefaultTermsTable);
    ...
    public SmallStringCompression(string[] termsTable)
    {
        ...
        for (int i = 0; i < termsTable.Length; i++)
        {
            ...
            byte* ptr = (byte*)NativeMemory.Alloc((nuint)(byteCount + 2));
    ...
    public int Compress(byte* input, byte* output, int inputLen, int outputLen)
    {
        ...
        for (int i = 0; i < inputLen; i++)
        {
            ...
            {
                byte*[] slot = size switch
                {
                    1 => _hashTable[h1 % _hashTable.Length],
                    2 => _hashTable[h2 % _hashTable.Length],
                    _ => _hashTable[h3 % _hashTable.Length],
                };
