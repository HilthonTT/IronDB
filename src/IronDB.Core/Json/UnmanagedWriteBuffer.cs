...
public unsafe struct UnmanagedWriteBuffer : IUnmanagedWriteBuffer
{
    ...
    private sealed class Segment
    {
        ...
        /// </summary>
        public AllocatedMemoryData Allocation = null!;
    ...
    public int CopyTo(int start, byte* pointer)
    {
        ...
        for (Segment? head = _head; head != null && whereToWrite > pointer; head = head.Previous)
        {
    ...
    public int CopyTo(byte* pointer)
    {
        ...
        for (Segment? head = _head; head != null; head = head.Previous)
        {
