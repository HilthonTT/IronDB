...
public struct Size
{
    public static readonly Size Zero = new(0, SizeUnit.Bytes);
    ...
    private static long ConvertToBytes(long value, SizeUnit unit)
    {
        return unit switch
        {
            ...
            SizeUnit.Kilobytes => value * OneKb,
            SizeUnit.Megabytes => value * OneMb,
            SizeUnit.Gigabytes => value * OneGb,
            SizeUnit.Terabytes => value * OneTb,
            _ => throw new NotSupportedException("Not supported size unit: " + unit),
        };
    }
    ...
    {
        return obj is Size size && _valueInBytes == size._valueInBytes;
    }
