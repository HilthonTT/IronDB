...
public static class AdvInstructionSet
{
    ...
    static AdvInstructionSet()
    {
        ...
        switch (Environment.GetEnvironmentVariable("IRONDB_AdvInstructions_Disable_VectorsBiggerThan")?.ToLowerInvariant())
        {
            case "256":
                IsAcceleratedVector512 = false;
                break;
    ...
    public static class X86
    {
        ...
        static X86()
        {
            ...
            switch (Environment.GetEnvironmentVariable("IRONDB_AdvInstructions_Disable_Intel_InstSet")?.ToLowerInvariant())
            {
                case "sse":
                    IsSupportedSse = false;
                    goto case "avx256";
