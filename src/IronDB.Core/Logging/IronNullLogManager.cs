...
internal sealed class IronNullLogManager : IIronLogManager
{
    public static readonly IronNullLogManager Instance = new();

    public event EventHandler<IronLoggingConfigurationChangedEventArgs> ConfigurationChanged = delegate { };

    public IIronLogger GetLogger(string name)
    {
    ...
    private sealed class IronNullLogger : IIronLogger
    {
        public static readonly IronNullLogger Instance = new();

        private IronNullLogger()
        {
        }
        ...
        public IIronLogger WithProperty(string propertyKey, object propertyValue) => this;
    }
}