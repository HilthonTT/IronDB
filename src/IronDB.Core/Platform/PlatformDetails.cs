...
public static class PlatformDetails
{
    ...
    {
        RunningOnDocker = string.Equals(Environment.GetEnvironmentVariable("IRON_IN_DOCKER"), "true", StringComparison.OrdinalIgnoreCase);
    ...
    private static bool TryGetWindowsVersion(out decimal version)
    {
        ...
        try
        {
            ...
            ver = string.Concat(ver.AsSpan(0, index), ver.AsSpan(index + 1));
