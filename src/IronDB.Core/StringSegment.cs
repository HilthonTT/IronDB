    ...
    */
    ...
    private static void ThrowInvalidArguments(string? buffer, int offset, int length)
    {
        ...
        Exception GetInvalidArgumentsException()
        {
            ...
            return ThrowHelper.GetArgumentException("Offset and length are out of bounds for the string or length is greater than the number of characters from index to the end of the string.");
        }
    }
    ...
    private void ThrowInvalidArguments(int offset, int length)
    {
        ...
        Exception GetInvalidArgumentsException(bool hasValue)
        {
            ...
            return ThrowHelper.GetArgumentException("Offset and length are out of bounds for this StringSegment or length is greater than the number of characters to the end of this StringSegment.");
        }
    }
